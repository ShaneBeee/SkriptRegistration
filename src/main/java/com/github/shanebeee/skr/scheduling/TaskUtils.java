package com.github.shanebeee.skr.scheduling;

import ch.njol.skript.Skript;
import com.github.shanebeee.skr.scheduling.scheduler.FoliaScheduler;
import com.github.shanebeee.skr.scheduling.scheduler.Scheduler;
import com.github.shanebeee.skr.scheduling.scheduler.SpigotScheduler;
...
public class TaskUtils {
    ...
    static boolean IS_FOLIA_SERVER;
    private static SpigotScheduler spigotScheduler;
    ...
    public static void initialize(@NotNull Plugin plugin, boolean useFoliaSchedulers) {
        ...
        IS_FOLIA_SERVER = Skript.classExists("io.papermc.paper.threadedregions.FoliaWatchdogThread");
    }
    ...
    public static Scheduler<?> getGlobalScheduler() {
        ...
        if (spigotScheduler == null) {
            spigotScheduler = new SpigotScheduler();
        }
