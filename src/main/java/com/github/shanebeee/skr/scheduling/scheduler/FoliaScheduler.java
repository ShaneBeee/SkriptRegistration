package com.github.shanebeee.skr.scheduling.scheduler;

import com.github.shanebeee.skr.scheduling.TaskUtils;
import com.github.shanebeee.skr.scheduling.scheduler.task.FoliaTask;
...
public class FoliaScheduler implements Scheduler<ScheduledTask> {
    ...
    FoliaScheduler(@Nullable Entity entity, @Nullable Location location) {
        this.entity = entity;
